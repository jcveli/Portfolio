...
const AboutDetails = () => {
    return (       
        <div className='details-container'>
            ...
            methodoloy.<br /> <br />
            Feel free to take a look at my resume to look at my skills, <a href='https://www.linkedin.com/in/jvelicaria/'>
            LinkedIn</a>, and <a href='https://github.com/jcveli'>GitHub</a>. 
            </p>
